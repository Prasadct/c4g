...
public class Disease extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fl.execute(getResources().getString(R.string.service_url)+"GetDetailsForMainType.php?mainType=Disease&cropId="+DashBoard.cropId);
	...
	private void loadList(){
		...
		list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				intent.putExtra("url", getResources().getString(R.string.service_url)+"Disease.php?cropId="+DashBoard.cropId+"&id="+ids[position]);
